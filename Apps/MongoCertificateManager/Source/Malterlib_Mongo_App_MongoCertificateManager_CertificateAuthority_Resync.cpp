...
{
	TCFuture<uint32> CMongoCertificateManagerActor::fp_CommandLine_AuthorityResync(CEJSONSorted const &_Params, NStorage::TCSharedPointer<CCommandLineControl> const &_pCommandLine)
	{
