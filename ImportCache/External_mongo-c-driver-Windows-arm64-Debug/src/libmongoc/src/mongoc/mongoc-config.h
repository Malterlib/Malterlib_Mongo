...
#define MONGOC_USER_SET_LDFLAGS "/machine:ARM64"

/* MONGOC_CC is used to determine what C compiler was used to compile mongoc */
#define MONGOC_CC "C:/Program Files/Microsoft Visual Studio/2022/Professional/VC/Tools/MSVC/14.37.32822/bin/Hostarm64/arm64/cl.exe"
