...
#define MONGOC_USER_SET_LDFLAGS "-fuse-ld=lld -stdlib=libc++ -Wno-unused-command-line-argument -L"../../../../../../../../../Binaries/MalterlibLLVM/Linux/x64/lib/x86_64-unknown-linux-gnu""
